...
#$(mname) is an interpolation placeholder for passing migration name to it. Usage eg: make migrations mname=SomeMigrationName
migrations:
...
goto-migration:
	cd ./SolarCoffee.Data && dotnet ef database update $(mname) --startup-project ../SolarCoffee.Web/ && cd ..
remove-last-migration:
	cd ./SolarCoffee.Data && dotnet ef migrations remove --startup-project ../SolarCoffee.Web/ && cd .. 
